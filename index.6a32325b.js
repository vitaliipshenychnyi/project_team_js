 ...
 * limitations under the License.
 */
var pe=function(t){"use strict";e(C)(r,t);var n=e(B)(r);function r(t,i,a){var o;return e(x)(this,r),(o=n.call(this,i)).code=t,o.customData=a,o.name="FirebaseError",Object.setPrototypeOf(e(O)(o),r.prototype),Error.captureStackTrace&&Error.captureStackTrace(e(O)(o),de.prototype.create),o}return r}(e(R)(Error)),de=function(){"use strict";function t(n,r,i){e(x)(this,t),this.service=n,this.serviceName=r,this.errors=i}return e(T)(t,[{key:"create",value:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var i=n[0]||{},a="".concat(this.service,"/").concat(e),o=this.errors[e],s=o?he(o,i):"Error",u="".concat(this.serviceName,": ").concat(s," (").concat(a,")."),c=new pe(a,u,i);return c}}]),t}();function he(e,t){return e.replace(ve,(function(e,n){var r=t[n];return null!=r?String(r):"<".concat(n,"?>")}))}var ve=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function On(){return On=e(a)(e(s).mark((function t(n){var r,i,a,o,u,c,l=arguments;return e(s).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=l.length>1&&void 0!==l[1]&&l[1],i=xe(n),e.next=4,i.getIdToken(r);case 4:return a=e.sent,Zt((o=Rn(a))&&o.exp&&o.auth_time&&o.iat,i.auth,"internal-error"),u="object"==typeof o.firebase?o.firebase:void 0,c=null==u?void 0:u.sign_in_provider,e.abrupt("return",{claims:o,token:a,authTime:Sn(Cn(o.auth_time)),issuedAtTime:Sn(Cn(o.iat)),expirationTime:Sn(Cn(o.exp)),signInProvider:c||null,signInSecondFactor:(null==u?void 0:u.sign_in_second_factor)||null});case 10:case"end":return e.stop()}}),t)}))),On.apply(this,arguments)}function Cn(e){return 1e3*Number(e)}function Rn(t){var n=e(S)(t.split("."),3),r=n[0],i=n[1],a=n[2];if(void 0===r||void 0===i||void 0===a)return Jt("JWT malformed, contained fewer than 3 sections"),null;try{var o=re(i);return o?JSON.parse(o):(Jt("Failed to decode base64 JWT payload"),null)}catch(e){return Jt("Caught error parsing JWT payload as JSON",null==e?void 0:e.toString()),null}}function An(e,t){return Pn.apply(this,arguments)}function Pn(){return Pn=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Qr=function(){"use strict";function t(n){e(x)(this,t),this.providerId=n,this.defaultLanguageCode=null,this.customParameters={}}return e(T)(t,[{key:"setDefaultLanguage",value:function(e){this.defaultLanguageCode=e}},{key:"setCustomParameters",value:function(e){return this.customParameters=e,this}},{key:"getCustomParameters",value:function(){return this.customParameters}}]),t}(),Zr=function(t){"use strict";e(C)(r,t);var n=e(B)(r);function r(){var t;return e(x)(this,r),(t=n.call.apply(n,[this].concat(Array.prototype.slice.call(arguments)))).scopes=[],t}return e(T)(r,[{key:"addScope",value:function(e){return this.scopes.includes(e)||this.scopes.push(e),this}},{key:"getScopes",value:function(){return e(o)(this.scopes)}}]),r}(Qr),ei=function(t){"use strict";e(C)(r,t);var n=e(B)(r);function r(){return e(x)(this,r),n.call(this,"facebook.com")}return e(T)(r,null,[{key:"credential",value:function(e){return Hr._fromParams({providerId:r.PROVIDER_ID,signInMethod:r.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}},{key:"credentialFromResult",value:function(e){return r.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return r.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t||!("oauthAccessToken"in t))return null;if(!t.oauthAccessToken)return null;try{return r.credential(t.oauthAccessToken)}catch(e){return null}}}]),r}(Zr);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var ti=function(t){"use strict";e(C)(r,t);var n=e(B)(r);function r(){var t;return e(x)(this,r),(t=n.call(this,"google.com")).addScope("profile"),t}return e(T)(r,null,[{key:"credential",value:function(e,t){return Hr._fromParams({providerId:r.PROVIDER_ID,signInMethod:r.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}},{key:"credentialFromResult",value:function(e){return r.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return r.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t)return null;var n=t.oauthIdToken,i=t.oauthAccessToken;if(!n&&!i)return null;try{return r.credential(n,i)}catch(e){return null}}}]),r}(Zr);ti.GOOGLE_SIGN_IN_METHOD="google.com",ti.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var ui=function(t){"use strict";e(C)(r,t);var n=e(B)(r);function r(t,i,a,o){var s,u;return e(x)(this,r),(s=n.call(this,i.code,i.message)).operationType=a,s.user=o,Object.setPrototypeOf(e(O)(s),r.prototype),s.customData={appName:t.name,tenantId:null!==(u=t.tenantId)&&void 0!==u?u:void 0,_serverResponse:i.customData._serverResponse,operationType:a},s}return e(T)(r,null,[{key:"_fromErrorAndOperation",value:function(e,t,n,i){return new r(e,t,n,i)}}]),r}(pe);function ci(e,t,n,r){return("reauthenticate"===t?n._getReauthenticationResolver(e):n._getIdTokenResponse(e)).catch((function(n){if("auth/multi-factor-auth-required"===n.code)throw ui._fromErrorAndOperation(e,n,t,r);throw n}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
