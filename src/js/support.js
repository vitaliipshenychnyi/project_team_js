...
import img1 from '/src/img/support-icon/action@1x.png';
...
function onClick() {
  ...
  // // вверх
  //   }
  refs.iconSvgBtnEl.innerHTML = `<svg class="support-icon" width="7" height="13"> <use href= "/src/img/svg/sprite.svg#icon-scroll-${
    isChangeIcon ? 'down' : 'up'
  }"></use>  </svg>`;
}
